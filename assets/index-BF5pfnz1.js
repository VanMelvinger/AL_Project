 ...
 */var Dv;function N_(){if(Dv)return Oo;Dv=1;var a=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(s,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:a,type:s,key:h,ref:l!==void 0?l:null,props:c}}return Oo.Fragment=e,Oo.jsx=i,Oo.jsxs=i,Oo}var Uv;function O_(){return Uv||(Uv=1,$f.exports=N_()),$f.exports}var X=O_(),eh={exports:{}},lt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`)+`
`+x);const B=I+y+h,R=I+x+d,Y=C0(l,l.VERTEX_SHADER,B),k=C0(l,l.FRAGMENT_SHADER,R);l.attachShader(b,Y),l.attachShader(b,k),i.index0AttributeName!==void 0?l.bindAttribLocation(b,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(b,0,"position"),l.linkProgram(b);function F(H){if(a.debug.checkShaderErrors){const K=l.getProgramInfoLog(b)||"",ce=l.getShaderInfoLog(Y)||"",ee=l.getShaderInfoLog(k)||"",O=K.trim(),w=ce.trim(),z=ee.trim();let P=!0,ue=!0;if(l.getProgramParameter(b,l.LINK_STATUS)===!1)if(P=!1,typeof a.debug.onShaderError=="function")a.debug.onShaderError(l,b,Y,k);else{const de=R0(l,Y,"vertex"),L=R0(l,k,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(b,l.VALIDATE_STATUS)+`
...
#`));this.skipRendering=e===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(a)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(a,e=Lr){this.fullscreenMaterial.depthBuffer=a,this.fullscreenMaterial.depthPacking=e;for(const i of this.effects)i.setDepthTexture(a,e)}render(a,e,i,s,l){for(const c of this.effects)c.update(a,e,s);if(!this.skipRendering||this.renderToScreen){const c=this.fullscreenMaterial;c.inputBuffer=e.texture,c.time+=s*this.timeScale,a.setRenderTarget(this.renderToScreen?null:i),a.render(this.scene,this.camera)}}setSize(a,e){this.fullscreenMaterial.setSize(a,e);for(const i of this.effects)i.setSize(a,e)}initialize(a,e,i){this.renderer=a;for(const s of this.effects)s.initialize(a,e,i);this.updateMaterial(),i!==void 0&&i!==Un&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const a of this.effects)a.removeEventListener("change",this.listener),a.dispose()}handleEvent(a){switch(a.type){case"change":this.recompile();break}}};const IC=({effectOptions:a={onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:10,islandWidth:2,lanesPerRoad:4,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:20,lightPairsPerRoadWay:40,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.03,400*.2],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.8,.8],carFloorSeparation:[0,5],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:16777215,brokenLines:16777215,leftCars:[14177983,6770850,12732332],rightCars:[242627,941733,3294549],sticks:242627}}})=>{const e=en.useRef(null),i=en.useRef(null);return en.useEffect(()=>{if(i.current){i.current.dispose();const ee=document.getElementById("lights");if(ee)for(;ee.firstChild;)ee.removeChild(ee.firstChild)}const s={uFreq:{value:new q(3,6,10)},uAmp:{value:new q(30,30,20)}},l={uFreq:{value:new Pe(5,2)},uAmp:{value:new Pe(25,15)}},c={uFreq:{value:new Pe(2,3)},uAmp:{value:new Pe(35,10)}},h={uFreq:{value:new Kt(4,8,8,1)},uAmp:{value:new Kt(25,5,10,10)}},d={uFreq:{value:new Pe(4,8)},uAmp:{value:new Pe(10,20)},uPowY:{value:new Pe(20,2)}};let m=ee=>Math.sin(ee)*.5+.5;const p={mountainDistortion:{uniforms:s,getDistortion:`
    ...
    `;function ce(ee,O){const w=ee.domElement,z=w.clientWidth,P=w.clientHeight,ue=w.width!==z||w.height!==P;return ue&&O(z,P,!1),ue}return(function(){const ee=document.getElementById("lights"),O={...a};O.distortion=p[O.distortion];const w=new v(ee,O);i.current=w,w.loadAssets().then(w.init)})(),()=>{i.current&&i.current.dispose()}},[a]),X.jsx("div",{id:"lights",ref:e})};function Ii(a={}){const e=en.useRef(null),[i,s]=en.useState(!1);return en.useEffect(()=>{const l=new IntersectionObserver(([h])=>{h.isIntersecting&&s(!0)},{threshold:.1,...a}),c=e.current;return c&&l.observe(c),()=>{c&&l.unobserve(c)}},[a]),[e,i]}function zC(){const[a,e]=Ii(),[i,s]=Ii(),[l,c]=Ii(),[h,d]=Ii(),[m,p]=Ii(),[v,g]=Ii(),[_,S]=Ii(),[M,b]=Ii(),[y,x]=Ii(),[I,B]=Ii();return X.jsxs("div",{className:"app-container",children:[X.jsx(IC,{effectOptions:{onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:10,islandWidth:2,lanesPerRoad:4,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:20,lightPairsPerRoadWay:40,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.03,400*.2],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.8,.8],carFloorSeparation:[0,5],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:16777215,brokenLines:16777215,leftCars:[14177983,6770850,12732332],rightCars:[242627,941733,3294549],sticks:242627}}}),X.jsx(W0,{}),X.jsxs("main",{className:"pt-24 min-h-screen text-white flex items-center justify-center w-full relative overflow-hidden",children:[X.jsx("div",{className:"absolute top-20 left-10 w-72 h-72 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"}),X.jsx("div",{className:"absolute bottom-20 right-10 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10"}),X.jsx("div",{className:"w-full max-w-[1200px] px-6 mx-auto relative z-10",children:X.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8 items-center",children:[X.jsxs("div",{ref:a,className:`text-left transition-all duration-1000 ${e?"opacity-100 translate-x-0":"opacity-0 -translate-x-20"}`,children:[X.jsx("div",{className:"mb-6",children:X.jsx("div",{className:"flex items-center gap-3 w-fit px-6 py-3 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-cyan-900 border border-cyan-500 shadow-lg backdrop-blur-sm",children:X.jsx("p",{className:"text-cyan-400 font-semibold tracking-wide text-lg md:text-xl italic",children:'"Trying to do better ✨"'})})}),X.jsxs("h1",{className:"text-3xl md:text-5xl font-bold mb-4 leading-tight",children:["Halo, Saya ",X.jsx("span",{className:"text-cyan-400",children:"Thoriq Al-Kautsar"})]}),X.jsx("p",{className:"text-white/70 md:text-lg mb-6",children:"Siswa SMAN 62 Jakarta yang sedang mengembangkan portfolio pribadi berbasis website. Website ini menjadi ruang untuk memperkenalkan diri, kegiatan, dan karya saya."}),X.jsxs("div",{className:"grid grid-cols-3 gap-4 mt-8",children:[X.jsxs("div",{className:"bg-gradient-to-br from-slate-800 to-slate-900 p-4 rounded-xl border border-cyan-500/20 backdrop-blur-sm",children:[X.jsx("div",{className:"text-2xl font-bold text-cyan-400",children:"4+"}),X.jsx("div",{className:"text-xs text-white/60",children:"Organisasi"})]}),X.jsxs("div",{className:"bg-gradient-to-br from-slate-800 to-slate-900 p-4 rounded-xl border border-cyan-500/20 backdrop-blur-sm",children:[X.jsx("div",{className:"text-2xl font-bold text-cyan-400",children:"3+"}),X.jsx("div",{className:"text-xs text-white/60",children:"Prestasi"})]}),X.jsxs("div",{className:"bg-gradient-to-br from-slate-800 to-slate-900 p-4 rounded-xl border border-cyan-500/20 backdrop-blur-sm",children:[X.jsx("div",{className:"text-2xl font-bold text-cyan-400",children:"2025"}),X.jsx("div",{className:"text-xs text-white/60",children:"Active"})]})]})]}),X.jsx("div",{className:"flex justify-center md:justify-end",children:X.jsx(j_,{name:"Thoriq Al-Kautsar",title:"Siswa SMAN 62 JAKARTA",handle:"Thoriqqq_27",status:"Online",contactText:"Contact Me",avatarUrl:"assets/THORIQ.png",showUserInfo:!0,enableTilt:!0,enableMobileTilt:!1,onContactClick:()=>console.log("Contact clicked")})})]})})]}),X.jsxs("section",{id:"profile",className:"relative py-20 overflow-hidden w-full",children:[X.jsxs("div",{className:"absolute inset-0 overflow-hidden",children:[X.jsx("div",{className:"absolute top-0 left-1/4 w-64 h-64 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-5"}),X.jsx("div",{className:"absolute bottom-0 right-1/4 w-80 h-80 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5"})]}),X.jsx("div",{className:"absolute inset-0 opacity-10",style:{backgroundImage:"linear-gradient(rgba(51,255,252,0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(51,255,252,0.1) 1px, transparent 1px)",backgroundSize:"50px 50px"}}),X.jsxs("div",{className:"w-full max-w-[1000px] px-6 mx-auto relative z-10",children:[X.jsxs("div",{className:"text-center mb-10",children:[X.jsxs("h2",{ref:i,className:`text-3xl md:text-4xl font-bold text-cyan-400 mb-3 transition-all duration-1000 delay-1000 relative inline-block ${s?"opacity-100 translate-y-0":"opacity-0 -translate-y-10"}`,children:["Tentang Saya",X.jsx("div",{className:"absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent"})]}),X.jsx("p",{ref:l,className:`text-white/70 max-w-2xl mx-auto transition-all duration-1000 ${c?"opacity-100 translate-y-0":"opacity-0 -translate-y-10"}`,style:{transitionDelay:"1200ms"},children:"Sedikit cerita tentang siapa saya dan apa yang saya sukai 🌟"})]}),X.jsxs("div",{className:"relative",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-cyan-500/5 via-transparent to-purple-500/5 rounded-2xl blur-xl"}),X.jsxs("div",{className:"relative border border-white/10 rounded-2xl p-8 bg-gradient-to-br from-slate-900/90 via-slate-800/90 to-slate-900/90 backdrop-blur-sm transition-all duration-500 hover:border-cyan-400/30",children:[X.jsx("p",{className:"text-white/80 leading-relaxed md:text-lg",children:"Saya Thoriq, siswa SMAN 62 Jakarta yang memiliki ketertarikan besar pada dunia teknologi, desain, dan pengembangan diri. Saya senang mempelajari hal-hal baru, terutama yang berkaitan dengan kreativitas digital dan pemrograman. Dalam setiap kegiatan, saya berusaha untuk terus berkembang dan memberikan hasil terbaik."}),X.jsx("p",{className:"text-white/80 leading-relaxed md:text-lg mt-4",children:"Bagi saya, membuat sesuatu yang bermanfaat bagi orang lain adalah kepuasan tersendiri. Karena itu, saya menjadikan web portfolio ini sebagai tempat untuk menunjukkan perjalanan dan karya saya ke depannya 🚀"}),X.jsxs("div",{className:"mt-8 flex flex-wrap gap-4 justify-center md:justify-start",children:[X.jsxs("div",{className:"group bg-gradient-to-r from-slate-800/50 to-slate-900/30 px-5 py-3 rounded-xl text-sm text-cyan-400 border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105",children:[X.jsx("span",{className:"inline-block",children:"💻"})," Pemrograman"]}),X.jsxs("div",{className:"group bg-gradient-to-r from-slate-800/50 to-slate-900/30 px-5 py-3 rounded-xl text-sm text-cyan-400 border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105",children:[X.jsx("span",{className:"inline-block",children:"🎨"})," Desain Kreatif"]}),X.jsxs("div",{className:"group bg-gradient-to-r from-slate-800/50 to-slate-900/30 px-5 py-3 rounded-xl text-sm text-cyan-400 border border-cyan-500/20 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105",children:[X.jsx("span",{className:"inline-block",children:"📚"})," Pembelajar Aktif"]})]})]})]})]})]}),X.jsxs("section",{id:"ekstrakurikuler",className:"relative py-20 w-full overflow-hidden",children:[X.jsxs("div",{className:"absolute inset-0",children:[X.jsx("div",{className:"absolute top-1/4 right-0 w-96 h-96 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-5 animate-pulse"}),X.jsx("div",{className:"absolute bottom-1/4 left-0 w-80 h-80 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5"})]}),X.jsxs("div",{className:"w-full max-w-[1200px] px-6 mx-auto text-center relative z-10",children:[X.jsxs("h2",{ref:h,className:`text-3xl md:text-4xl font-bold text-cyan-400 mb-4 transition-all duration-1000 delay-1000 relative inline-block ${d?"opacity-100 translate-x-0":"opacity-0 -translate-x-20"}`,children:["Ekstrakurikuler & Organisasi",X.jsx("div",{className:"absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent"})]}),X.jsx("p",{ref:m,className:`text-white/70 mb-12 max-w-2xl mx-auto transition-all duration-1000 ${p?"opacity-100 translate-x-0":"opacity-0 translate-x-20"}`,style:{transitionDelay:"1200ms"},children:"Beberapa kegiatan sekolah dan organisasi yang saya ikuti untuk mengembangkan kemampuan, tanggung jawab, dan kerja sama."}),X.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8",children:[X.jsxs("div",{className:"group relative border border-white/10 rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm hover:border-cyan-400/50",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-cyan-400/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"}),X.jsx("img",{src:"assets/osis.jpg",alt:"OSIS",className:"w-full h-44 object-cover transition-transform duration-500 group-hover:scale-110"}),X.jsxs("div",{className:"p-4 text-left relative z-10",children:[X.jsxs("h3",{className:"text-xl font-semibold text-cyan-400 mb-2 flex items-center gap-2",children:[X.jsx("span",{className:"text-2xl",children:"🏛️"})," OSIS"]}),X.jsx("p",{className:"text-white/70 text-sm leading-relaxed",children:"Organisasi siswa yang mengajarkan kepemimpinan, tanggung jawab, dan kemampuan berorganisasi di lingkungan sekolah."})]})]}),X.jsxs("div",{className:"group relative border border-white/10 rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm hover:border-cyan-400/50",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-cyan-400/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"}),X.jsx("img",{src:"assets/pramuka.jpg",alt:"Pramuka",className:"w-full h-44 object-cover transition-transform duration-500 group-hover:scale-110"}),X.jsxs("div",{className:"p-4 text-left relative z-10",children:[X.jsxs("h3",{className:"text-xl font-semibold text-cyan-400 mb-2 flex items-center gap-2",children:[X.jsx("span",{className:"text-2xl",children:"⚜️"})," Pramuka"]}),X.jsx("p",{className:"text-white/70 text-sm leading-relaxed",children:"Melatih kemandirian, kedisiplinan, dan kerja sama melalui kegiatan kepanduan serta pembentukan karakter."})]})]}),X.jsxs("div",{className:"group relative border border-white/10 rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm hover:border-cyan-400/50",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-cyan-400/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"}),X.jsx("img",{src:"assets/rohis.jpg",alt:"Rohis",className:"w-full h-44 object-cover transition-transform duration-500 group-hover:scale-110"}),X.jsxs("div",{className:"p-4 text-left relative z-10",children:[X.jsxs("h3",{className:"text-xl font-semibold text-cyan-400 mb-2 flex items-center gap-2",children:[X.jsx("span",{className:"text-2xl",children:"🕌"})," Rohis"]}),X.jsx("p",{className:"text-white/70 text-sm leading-relaxed",children:"Kegiatan keagamaan Islam yang membentuk karakter religius, etika, dan kebersamaan antar siswa."})]})]}),X.jsxs("div",{className:"group relative border border-white/10 rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm hover:border-cyan-400/50",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-cyan-400/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"}),X.jsx("img",{src:"assets/badminton.jpg",alt:"Badminton",className:"w-full h-44 object-cover transition-transform duration-500 group-hover:scale-110"}),X.jsxs("div",{className:"p-4 text-left relative z-10",children:[X.jsxs("h3",{className:"text-xl font-semibold text-cyan-400 mb-2 flex items-center gap-2",children:[X.jsx("span",{className:"text-2xl",children:"🏸"})," Badminton"]}),X.jsx("p",{className:"text-white/70 text-sm leading-relaxed",children:"Meningkatkan sportivitas dan semangat kompetitif melalui latihan serta pertandingan bulu tangkis."})]})]})]})]})]}),X.jsxs("section",{id:"berita",className:"relative py-20 w-full overflow-hidden",children:[X.jsxs("div",{className:"absolute inset-0",children:[X.jsx("div",{className:"absolute top-1/3 left-1/3 w-72 h-72 bg-yellow-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5 animate-pulse"}),X.jsx("div",{className:"absolute bottom-1/3 right-1/3 w-64 h-64 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-5"})]}),X.jsxs("div",{className:"w-full max-w-[1000px] px-6 mx-auto relative z-10",children:[X.jsx("div",{className:"text-center mb-10",children:X.jsxs("h2",{ref:v,className:`text-3xl md:text-4xl font-bold text-cyan-400 mb-3 transition-all duration-1000 delay-1000 relative inline-block ${g?"opacity-100 scale-100":"opacity-0 scale-75"}`,children:["Berita & Prestasi",X.jsx("div",{className:"absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent"})]})}),X.jsxs("div",{className:"relative",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-yellow-500/5 via-transparent to-cyan-400/5 rounded-2xl blur-2xl"}),X.jsxs("div",{className:"relative border border-white/10 rounded-2xl p-8 space-y-5 bg-gradient-to-br from-slate-900/90 via-slate-800/90 to-slate-900/90 backdrop-blur-sm",children:[X.jsxs("div",{className:"group flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-yellow-500/10 to-transparent border border-yellow-500/20 hover:border-yellow-500/50 transition-all duration-300 hover:scale-105",children:[X.jsx("span",{className:"text-3xl",children:"🥇"}),X.jsxs("div",{children:[X.jsx("p",{className:"text-white/90 text-lg font-semibold",children:"Juara 1 Lomba Badminton Ganda Putra"}),X.jsx("p",{className:"text-white/50 text-sm",children:"2019"})]})]}),X.jsxs("div",{className:"group flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-orange-500/10 to-transparent border border-orange-500/20 hover:border-orange-500/50 transition-all duration-300 hover:scale-105",children:[X.jsx("span",{className:"text-3xl",children:"🏸"}),X.jsxs("div",{children:[X.jsx("p",{className:"text-white/90 text-lg font-semibold",children:"Juara Harapan 3 Lomba Badminton Tunggal Putra"}),X.jsx("p",{className:"text-white/50 text-sm",children:"2021"})]})]}),X.jsxs("div",{className:"group flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-cyan-400/10 to-transparent border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 hover:scale-105",children:[X.jsx("span",{className:"text-3xl",children:"🎖️"}),X.jsxs("div",{children:[X.jsx("p",{className:"text-white/90 text-lg font-semibold",children:"Juara Harapan 1 Lomba Yel-Yel Napak Tilas"}),X.jsx("p",{className:"text-white/50 text-sm",children:"2025"})]})]})]})]})]})]}),X.jsxs("section",{id:"gallery",className:"relative py-24 overflow-hidden w-full",children:[X.jsx("div",{className:"absolute inset-0 opacity-30",style:{backgroundImage:"radial-gradient(circle at center, rgba(51,255,252,0.08) 1px, transparent 1px)",backgroundSize:"30px 30px"}}),X.jsx("div",{className:"absolute top-20 right-20 w-64 h-64 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"}),X.jsx("div",{className:"absolute bottom-20 left-20 w-80 h-80 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10"}),X.jsxs("div",{className:"w-full max-w-[1200px] px-6 mx-auto relative z-10",children:[X.jsxs("div",{className:"text-center mb-14",children:[X.jsxs("h2",{ref:_,className:`text-3xl md:text-4xl font-bold text-cyan-400 mb-3 transition-all duration-1000 delay-1000 relative inline-block ${S?"opacity-100 translate-y-0 rotate-0":"opacity-0 translate-y-10 -rotate-3"}`,children:["📸 Gallery 📸",X.jsx("div",{className:"absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent"})]}),X.jsx("div",{ref:M,className:`w-24 h-0.5 bg-gradient-to-r from-transparent via-cyan-400 to-transparent mx-auto mb-4 transition-all duration-1000 ${b?"opacity-100 scale-x-100":"opacity-0 scale-x-0"}`,style:{transitionDelay:"1300ms"}})]}),X.jsx("div",{className:"columns-2 sm:columns-3 md:columns-4 gap-4 space-y-4",children:["assets/Anak12E.jpg","assets/Apis.png","assets/apis2.png","assets/Kelas12e.jpg","assets/kelas12e1.jpg","assets/temen1.jpg","assets/TMB.jpg","assets/Drama1.jpg"].map((R,Y)=>X.jsxs("div",{className:"group relative overflow-hidden rounded-2xl border border-white/10 hover:scale-105 transition-all duration-300 break-inside-avoid hover:border-cyan-400/50",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-cyan-400/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"}),X.jsx("img",{src:R,alt:`Gallery ${Y+1}`,className:"w-full h-auto object-cover rounded-2xl group-hover:opacity-90 group-hover:scale-110 transition-all duration-500"})]},Y))})]})]}),X.jsxs("section",{id:"contact",className:"relative py-20 w-full overflow-hidden",children:[X.jsxs("div",{className:"absolute inset-0",children:[X.jsx("div",{className:"absolute top-0 left-1/4 w-96 h-96 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"}),X.jsx("div",{className:"absolute bottom-0 right-1/4 w-80 h-80 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10"})]}),X.jsx("div",{className:"absolute inset-0 opacity-5",style:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(51,255,252,0.3) 35px, rgba(51,255,252,0.3) 36px)"}}),X.jsxs("div",{className:"w-full max-w-[900px] px-6 mx-auto text-center relative z-10",children:[X.jsxs("h2",{ref:y,className:`text-3xl md:text-4xl font-bold text-cyan-400 mb-6 transition-all duration-1000 delay-1000 relative inline-block ${x?"opacity-100 translate-y-0":"opacity-0 translate-y-10"}`,children:["Hubungi Saya",X.jsx("div",{className:"absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent"})]}),X.jsx("p",{ref:I,className:`text-white/70 mb-10 transition-all duration-1000 ${B?"opacity-100 translate-y-0":"opacity-0 translate-y-10"}`,style:{transitionDelay:"1200ms"},children:"Jangan ragu untuk terhubung dengan saya melalui media sosial berikut! 💬"}),X.jsxs("div",{className:"flex justify-center gap-8 flex-wrap",children:[X.jsxs("a",{href:"https://wa.me/6281290301826",target:"_blank",rel:"noopener noreferrer",className:"group relative",children:[X.jsx("div",{className:"absolute inset-0 bg-green-500 rounded-2xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300"}),X.jsxs("div",{className:"relative transition-all duration-300 p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm group-hover:scale-110 group-hover:border-green-500/50",children:[X.jsx("i",{className:"fa-brands fa-whatsapp text-4xl text-green-500 group-hover:text-white transition-all group-hover:scale-110"}),X.jsx("p",{className:"text-white/60 text-xs mt-2 group-hover:text-white/90 transition-colors",children:"WhatsApp"})]})]}),X.jsxs("a",{href:"https://instagram.com/Thriqqq_27",target:"_blank",rel:"noopener noreferrer",className:"group relative",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-tr from-purple-500 via-pink-500 to-orange-500 rounded-2xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300"}),X.jsxs("div",{className:"relative transition-all duration-300 p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm group-hover:scale-110 group-hover:border-pink-500/50",children:[X.jsx("i",{className:"fa-brands fa-instagram text-4xl text-pink-500 group-hover:text-white transition-all group-hover:scale-110"}),X.jsx("p",{className:"text-white/60 text-xs mt-2 group-hover:text-white/90 transition-colors",children:"Instagram"})]})]}),X.jsxs("a",{href:"https://facebook.com/Thirstyy",target:"_blank",rel:"noopener noreferrer",className:"group relative",children:[X.jsx("div",{className:"absolute inset-0 bg-blue-600 rounded-2xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300"}),X.jsxs("div",{className:"relative transition-all duration-300 p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm group-hover:scale-110 group-hover:border-blue-500/50",children:[X.jsx("i",{className:"fa-brands fa-facebook-f text-4xl text-blue-500 group-hover:text-white transition-all group-hover:scale-110"}),X.jsx("p",{className:"text-white/60 text-xs mt-2 group-hover:text-white/90 transition-colors",children:"Facebook"})]})]}),X.jsxs("a",{href:"https://www.tiktok.com/hfthr27",target:"_blank",rel:"noopener noreferrer",className:"group relative",children:[X.jsx("div",{className:"absolute inset-0 bg-cyan-400 rounded-2xl blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-300"}),X.jsxs("div",{className:"relative transition-all duration-300 p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-sm group-hover:scale-110 group-hover:border-cyan-400/50",children:[X.jsx("i",{className:"fa-brands fa-tiktok text-4xl text-white group-hover:text-cyan-400 transition-all group-hover:scale-110"}),X.jsx("p",{className:"text-white/60 text-xs mt-2 group-hover:text-white/90 transition-colors",children:"TikTok"})]})]})]}),X.jsxs("div",{className:"mt-16 relative",children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-cyan-400/10 via-purple-500/10 to-cyan-400/10 rounded-2xl blur-2xl"}),X.jsxs("div",{className:"relative border border-cyan-400/20 rounded-2xl p-8 bg-gradient-to-br from-slate-900/90 via-slate-800/90 to-slate-900/90 backdrop-blur-sm hover:border-cyan-400/40 transition-all duration-300",children:[X.jsx("p",{className:"text-white/80 text-lg mb-4",children:"Mari berkolaborasi dan berdiskusi! 🤝"}),X.jsx("p",{className:"text-white/60 text-sm",children:"Saya terbuka untuk project baru, diskusi teknologi, atau sekadar bertukar pikiran."})]})]})]})]}),X.jsx("footer",{className:"relative py-8 border-t border-white/10 bg-slate-900/50 backdrop-blur-sm",children:X.jsx("div",{className:"w-full max-w-[1200px] px-6 mx-auto text-center",children:X.jsxs("p",{className:"text-white/50 text-sm",children:["© 2025 Thoriq Al-Kautsar. Made with ",X.jsx("span",{className:"text-cyan-400",children:"❤️"})," and ",X.jsx("span",{className:"text-cyan-400",children:"React"})]})})})]})}X_.createRoot(document.getElementById("root")).render(X.jsx(Y0.StrictMode,{children:X.jsxs("div",{className:"container mx-auto px-6",children:[X.jsx(W0,{}),X.jsx(zC,{})]})}));
